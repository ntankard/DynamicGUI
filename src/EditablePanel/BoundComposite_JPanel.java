...
import com.ntankard.DynamicGUI.Components.EditablePanel.Rows.BoundRows;
import com.ntankard.DynamicGUI.Components.EditablePanel.Rows.PanelRows;
import com.ntankard.DynamicGUI.Components.EditablePanel.Rows.TableRow;
...
import static com.ntankard.DynamicGUI.Components.EditablePanel.Rows.BoundRows.data_C;
import static com.ntankard.DynamicGUI.Components.EditablePanel.Rows.BoundRows.lbl_C;
...
public class BoundComposite_JPanel extends JPanel implements Bound_JComponent {
    ...
    public void finalizePanel() {
        ...
        if (hadPublic()) {
            ...
            toAddP.setBorder(new TitledBorder("Util"));
            lbl_C.setRow(0);
            lbl_C.setRowSpan(2);
