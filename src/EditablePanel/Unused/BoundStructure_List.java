...
//        this.removeAll();
//
//        //JScrollPane scrollPane = new BoundArray_JList<>(objects,master);
...
//
//            // BoundComposite_JPanelGenerator ref = new BoundComposite_JPanelGenerator(objects.get(structure_list.getSelectedIndex()));
//
//            BoundComposite_JPanelGenerator r = new BoundComposite_JPanelGenerator();
//            BoundStructure_Dialog.openPanel(BoundComposite_JPanelGenerator.generate(objects.get(structure_list.getSelectedIndex())));
//
//            update();
//        }
//        if (master != null) {
