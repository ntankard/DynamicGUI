...
public abstract class DynamicGUI_DisplayList_Impl<T> extends UpdatableJScrollPane {
    ...
    /**
     * @param objects The master content of the list
     * @param master  The parent of this object to be notified if data changes
     */
    protected DynamicGUI_DisplayList_Impl(List<T> objects, Updatable master) {
        super(master);
