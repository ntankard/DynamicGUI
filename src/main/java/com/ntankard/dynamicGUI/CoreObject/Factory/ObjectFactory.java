...
import static com.ntankard.dynamicGUI.CoreObject.Factory.ObjectFactory.GeneratorMode.GENERATOR_ONLY;

public abstract class ObjectFactory<GeneratedType extends CoreObject, GeneratorType extends CoreObject> {
